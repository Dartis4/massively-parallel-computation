...
%%                       period => integer()}   % mandatory. A number of seconds.
    ...
    %%
  Names = [query_facility_server1, query_facility_server2, query_facility_server3, query_facility_server4, query_facility_server5],

  Dispatcher_spec = generate_spec(query_facility_dispatcher, query_facility_dispatcher, worker, Names),
  Server_spec = generate_spec(query_facility_server_sup, query_facility_server_sup, supervisor, Names),
