...
%%                       period => integer()}   % mandatory. A number of seconds.
    ...
    %%
  Names = [query_package_server1, query_package_server2, query_package_server3, query_package_server4, query_package_server5],

  Dispatcher_spec = generate_spec(query_package_dispatcher, query_package_dispatcher, worker, Names),
  Server_spec = generate_spec(query_package_server_sup, query_package_server_sup, supervisor, Names),
