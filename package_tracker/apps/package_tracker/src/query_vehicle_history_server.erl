...
-export([query_vehicle_history/1,query_vehicle_history/2]).
...
query_vehicle_history(Name, Data) ->
  gen_server:call(Name, {get_vehicle_history, maps:get(<<"vehicle_uuid">>, Data)}).
