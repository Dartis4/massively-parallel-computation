...
%%                       period => integer()}   % mandatory. A number of seconds.
  ...
  Names = [query_vehicle_server1, query_vehicle_server2, query_vehicle_server3, query_vehicle_server4, query_vehicle_server5],

  Dispatcher_spec = generate_spec(query_vehicle_dispatcher, query_vehicle_dispatcher, worker, Names),
  Server_spec = generate_spec(query_vehicle_server_sup, query_vehicle_server_sup, supervisor, Names),
