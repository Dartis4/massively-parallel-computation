...
init([]) ->
  ...
  %%
  Names = [store_vehicle_server1, store_vehicle_server2, store_vehicle_server3, store_vehicle_server4, store_vehicle_server5],

  Dispatcher_spec = generate_spec(store_vehicle_dispatcher, store_vehicle_dispatcher, worker, Names),
  Server_spec = generate_spec(store_vehicle_server_sup, store_vehicle_server_sup, supervisor, Names),
